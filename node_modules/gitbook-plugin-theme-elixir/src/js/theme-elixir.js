require(['gitbook', 'jquery'], function(gitbook, $) {
    ...
    function init(config) {
        themeElixir = gitbook.storage.get('themeElixir', {
            split:       config.split,
            currentLang: null
        });
    }
    ...
    function saveSettings() {
        gitbook.storage.set('themeElixir', themeElixir);
        updateDisplay();
    }
    ...
    function updateDisplay() {
        // Update layout
        $('.book').toggleClass('two-columns', themeElixir.split);
        ...
        $codes.each(function() {
            // Show corresponding
            var hidden = !($(this).data('lang') == themeElixir.currentLang);
    ...
    function updateCodeTabs() {
        ...
        $codes.each(function() {
            ...
            if (codeLang == themeElixir.currentLang) {
                hasCurrentLang = true;
                isDefault = true;
            }
        ...
        $.each(languages, function(i, language) {
            ...
            buttonId = gitbook.toolbar.createButton({
                ...
                onClick: function(e) {
                    // Update language
                    themeElixir.currentLang = language.lang;
                    saveSettings();
    ...
    gitbook.events.bind('start', function(e, config) {
        ...
        gitbook.toolbar.createButton({
            ...
            onClick: function() {
                // Update layout
                themeElixir.split = !themeElixir.split;
                saveSettings();
            }
        });
