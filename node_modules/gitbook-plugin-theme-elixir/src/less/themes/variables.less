...
// Methods
@elixir-code-color-3:               @theme-3-gray-lightest;
@elixir-code-background-3:          @theme-3-gray-darkest;
@elixir-code-heading-color-3:       white;
@elixir-code-h6-color-3:            @theme-3-gray-light;

@elixir-code-pre-color-3:           @theme-3-gray-lightest;
@elixir-code-pre-background-3:      @theme-3-gray-dark;
